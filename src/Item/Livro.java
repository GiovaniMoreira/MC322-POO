...
public class Livro extends Item {
    ...
    public Livro(int tombo, String titulo, String autor, String editora, String genero, int anoPub, String sinopse, int ISBN, int edicao, String localizaçao, String conservacao) {
